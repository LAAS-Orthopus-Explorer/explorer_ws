...
class MpcControllerNode(Node):
    def __init__(self):
        ...
        # inv_idx_map: Pinocchio -> Gazebo
        self.inv_idx_map = [0]*len(self.idx_map)
        for i, idx in enumerate(self.idx_map):
            self.inv_idx_map[idx] = i

        # Timer periods in seconds 
        self.__controller_time_period = 0.05
    ...
    def joint_state_callback(self, msg: JointState):
        ...
        self.lates_joint_position = np.array([msg.position[i] for i in self.idx_map])
